...
public class CategoryDao implements Dao<Integer, Category> {
    ...
    public Category insert(Category category, Connection con) throws Exception {
        ...
        try {
            ...
            ps.setString(1, category.getCateno1()); // cateno1
            ps.setString(2, category.getCateno2()); // cateno2
            ps.setString(3, category.getCatename()); // catename
            ps.executeUpdate();
    ...
    public Category update(Category category, Connection con) throws Exception {
        ...
        try {
            ...
            ps.setString(1, category.getCateno1()); // 카테고리1 설정
            ps.setString(2, category.getCateno2()); // 카테고리2 설정
            ps.setString(3, category.getCatename()); // 카테고리 이름 설정
            ps.setInt(4, category.getCateno()); // WHERE 조건의 카테고리 번호 설정
